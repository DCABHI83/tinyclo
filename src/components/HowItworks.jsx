    ...
    <>
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="p-4 flex flex-col md:flex-row justify-evenly items-center md:w-[95%]">
          <div className="flex flex-col justify-center items-center shadow-slate-950 shadow-lg shadow-inset text-center mt-4 gap-4 rounded-2xl p-3 md:w-[25vw] md:h-[50vh] transform hover:scale-110 transition duration-300 cursor-pointer ">
            <div>
          ...
          <div className="flex flex-col justify-center items-center shadow-slate-950 shadow-lg shadow-inset text-center mt-4 gap-4 rounded-2xl p-3 md:w-[25vw] md:h-[50vh] transform hover:scale-110 transition duration-300 cursor-pointer">
            ...
            <h3 className="text-2xl">RENT</h3>
            <p className="text-2xl">
              When your little one outgrows their clothes, simply pop them back
              to us in the reusable bag. For FREE, of course
            </p>
          </div>
          <div className="flex flex-col justify-center items-center shadow-slate-950 shadow-lg shadow-inset text-center mt-4 gap-4 rounded-2xl p-3 md:w-[25vw] md:h-[50vh] transform hover:scale-110 transition duration-300 cursor-pointer">
            <div>
        ...
        <div>
          <NavLink to="#">
            <button className="bg-[#147AA9] text-4xl pr-4 pl-8 pt-2 pb-4 rounded-[7px] mt-7 text-white cursor-pointer">
              Start Membership
            </button>
          </NavLink>
        </div>
